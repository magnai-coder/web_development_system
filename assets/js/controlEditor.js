...
const controlEditor = {
    headerMark: window.parent.document.getElementById('render'),
...
var frameContent;
controlEditor.headerMark.onload = function() {
    frameContent = controlEditor.headerMark.contentWindow.document.getElementById("mainPage");
